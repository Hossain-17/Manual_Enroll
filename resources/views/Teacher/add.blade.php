   ...
   <main>
    <div class="container">
        ...
        <div class="form-group">
            ...
            <input type="teacher_id" value="{{ old('teacher_id') }}" class="form-control" placeholder="Enter ID" name="teacher_id">
        ...
        <div class="form-group">
            ...
            <a class="btn btn-secondary" href="{{ URL::to('teachers') }}">Back</a>
        </div>       
        </form>
