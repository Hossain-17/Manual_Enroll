...
<body>
    <div class="container">
        ...
        <div class="form-group">
            ...
            <input type="date" value="{{ old('dob') }}" class="form-control" placeholder="Enter Date" name="dob">
            @if($errors->first('dob'))
            <div class="alert alert-danger"> 
                {{ $errors->first('dob') }}        
            </div>  
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('semester') }}" class="form-control" placeholder="Enter Semester" name="semester">
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('batch') }}" class="form-control" placeholder="Enter Batch" name="batch">
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ old('adviser') }}" class="form-control" placeholder="Adviser Name" name="adviser">
